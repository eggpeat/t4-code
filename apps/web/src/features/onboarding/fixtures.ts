...
export const SERVICE_FIXTURES: Readonly<Record<ServiceStatus, ServiceViewModel>> = {
  ...
  "not-installed": {
    ...
    version: null,
    detail: "No systemd user service is installed for the appserver yet.",
    diagnostics: [],
  },
  installing: {
    platform: "systemd",
  ...
  "start-failed": {
    ...
    diagnostics: [
      ...
      "Appserver log ended with: address already in use",
  ...
  running: {
    ...
    status: "running",
    version: "0.3.0",
    detail: "Appserver 0.3.0 is running as a systemd user service.",
    diagnostics: [],
  },
};
...
export const SERVICE_RUNNING_LAUNCHD: ServiceViewModel = {
  ...
  status: "running",
  version: "0.3.0",
  detail: "Appserver 0.3.0 is running as a launchd agent.",
  diagnostics: [],
};
...
export const HOST_FIXTURES: Readonly<Record<HostConnectionState, HostRow>> = {
  starting: {
    ...
    identity: null,
    state: "starting",
    reason: "The appserver is up; waiting for it to finish loading sessions.",
    sessionCount: null,
    protocolLabel: null,
  },
  ready: {
  ...
  unavailable: {
    ...
    state: "unavailable",
    reason: "The host did not answer. It may be asleep, or its appserver is stopped.",
    sessionCount: null,
    protocolLabel: null,
  },
  reconnecting: {
  ...
  "version-skew": {
    ...
    state: "version-skew",
    reason: "This host runs an older appserver (0.2). Sessions work; terminals and file previews stay off until it updates.",
    sessionCount: 21,
