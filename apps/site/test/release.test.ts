// Release contract guard: exact v0.1.0 asset names and URLs, and the
...
describe("release assets", () => {
  it("carries the four contracted v0.1.0 filenames", () => {
    expect(RELEASE_ASSETS.map((a) => a.filename)).toEqual([
      "T4-Code-0.1.0-linux-amd64.deb",
      "T4-Code-0.1.0-linux-x86_64.AppImage",
      "T4-Code-0.1.0-mac-arm64.dmg",
      "T4-Code-0.1.0-mac-arm64.zip",
    ]);
  });
